          ...
          >
            <div className="flex items-center flex-1">
              <div className="flex items-center justify-between w-full md:w-auto">
                <a href="#">
                  <span className="sr-only">Meta Circle</span>
                  <img
              ...
              <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                <div>
                  ...
                  >
                    ...
                    <span className="ml-4 text-sm">Make an account</span>
                    <ChevronRightIcon className="ml-2 w-5 h-5 text-gray-500" aria-hidden="true" />
                  </a>
                  <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:leading-none lg:mt-6 lg:text-5xl xl:text-6xl">
                    <span className="md:block">Find a mentor that you ... </span>{' '}
                    <span className="text-blue-400 md:block">actually admire</span>
                  </h1>
                  <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                  Be the senior product manager or software engineer you wanted when you were a junior
                  </p>
                  
                  
                  {/* <p className="mt-8 text-sm text-white uppercase tracking-wide font-semibold sm:mt-10">Mentors from </p>
